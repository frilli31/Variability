...
if __name__ == "__main__":
    s1 = (
        ...
        "rhesus factor d - Centrifuge method - email",
        "leukocyte count electronic",
        "platelet count - Electronic",
        "gammaglutamyltranspeptidase",
        "CEA - tumor marker using meia",
        "calcium",
        "albumin",
        "red cell antibody screening",
        "ca-125 using meia",
        "differentiation leukocytes - manual",
        "order rate",
        ...
        "ABO blood group and rhesus factor",
        "rhesus factor d - Centrifuge method - email",
        "differential count automatically",
        "leukocyte count electronic",
        "platelet count - Electronic",
        "red cell antibody screening",
        "order rate",
        "190021 clinical admission A002",
        "190205 Class 3b A205",
        "190101 reg.toesl above. A101",
        "demurrage - all spec.beh.kinderg.-Reval.",
        "ovarian - ovarian redebulking CarCine",
        "immuno-pathology",
        "immuno-pathology",
        "cytology - ascites -",
        ...
        "glucose",
        "glucose",
        "methemoglobin - sulphemoglobin each",
        "hemoglobin photoelectric",
        "hemoglobin photoelectric",
        "bicarbonate",
        "Co-hb kwn.",
        ...
        "potassium potentiometrically",
        "platelet count - Electronic",
        "cefalinetijd - coagulation",
        "Current ph - PCO2 - stand.bicarbonaat",
    ...
    s2 = (
        ...
        "gammaglutamyltranspeptidase",
        "CEA - tumor marker using meia",
        "squamous cell carcinoma using eia",
        "calcium",
        "albumin",
        "red cell antibody screening",
        "ca-125 using meia",
        ...
        "ct abdomen",
        "First outpatient consultation",
        "interc.consult clinical anesthesia",
        "administrative fee - the first pol",
        "190021 clinical admission A002",
        "190205 Class 3b A205",
        "190101 reg.toesl above. A101",
        "demurrage - all spec.beh.kinderg.-Reval.",
        "cytology - lymfeklierpuncti",
        "Upper abdominal ultrasound",
        "ro gel. as ass. to puncture - biopsy l",
        "190205 Class 3b A205",
        "190101 reg.toesl above. A101",
        "demurrage - all spec.beh.kinderg.-Reval.",
        "190205 Class 3b A205",
